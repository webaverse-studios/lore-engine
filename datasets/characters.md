...
Class: Drop Hunter
Stats: ATK 51, DEF 20, VIT 20, SPR 12, DEX 50, LCK 7
...
Favorite Weapon: [Silsword](/items/Silsword)
Abilities:
...
Limit Break: **Lisk Wrath** Stats are doubled, and attack speed is 5x for a short time, or until 100 hits, whichever comes first.
Lore:
## Bio
...
Class: Neural Gunner
Stats: ATK 76, DEF 42, VIT 10, SPR 11, DEX 30, LCK 3
...
Favorite Weapon: [Final Roulette](/items/Final Roulette)
Abilities:
...
Limit Break: **Dark Mode** Drake gains invisibility and his movement speed is doubled. The first 3 attacks in this mode have 10x damage, but also make you visible for three seconds.
Lore:
## Bio
...
Class: Lisk Witch
Stats: ATK 13, DEF 10, VIT 42, SPR 71, DEX 44, LCK 20
...
Favorite Weapon: [Corpse Wand](/items/Corpse Wand)
Abilities:
...
Limit Break: **Rando Hex** A large AOE that applies a random debuff to all enemies, and a random buff to all allies it hits, including Ann.
Lore:
## Bio
...
Stats: ATK 31, DEF 20, VIT 76, SPR 52, DEX 30, LCK 25
Quotes:
...
Stats: ATK 42, DEF 93, VIT 45, SPR 5, DEX 12, LCK 25
Quotes:
...
Favorite Weapon: [Multitool](/items/Multitool)
Abilities:
...
Limit Break: **Engine Overload** An AoE buff that doubles the stats of all allied characters, pets, and vehicles in its radius, but also increases damage received by 50%.
Image Gallery:
...
Stats: ATK 85, DEF 85, VIT 30, SPR 10, DEX 12, LCK 2
Image Gallery:
...
Limit Break: **Busted Arsenal** Buster cycles through every weapon in his inventory, dealing 10x damage with each hit until the effect wears off.
Lore:
## Bio
...
Stats: ATK 20, DEF 12, VIT 9, SPR 81, DEX 73, LCK 5
Image Gallery:
...
Favorite Weapon: [Gaia Bow](/items/Gaia Bow)
Abilities:
...
Limit Break: **Wisp Form** Grants Sayu invincibility and flight for a short period of time. While in this form, Sayu can only perform melee attacks.
Lore:
## Bio
## Appearance
...
Name: Raver Kazu
Description: Kazu's first name is Raver, but he calls himself Kazu.
...
Class: Neo Punk
Alignment: Chaotic Neutral
Stats: ATK 10, DEF 10, VIT 40, SPR 40, DEX 100, LCK 20
Image Gallery:
...
Favorite Weapon: [Flash Brand](/items/Flash Brand)
Abilities:
...
Limit Break: **MP Break** Kazu gains infinite MP for a short time. This stacks with the [Infinicast](/abilities/Infinicast) ability.
Lore:
## Bio
...
Class: Drop Courier
Alignment: Neutral
Stats: ATK 35, DEF 75, VIT 20, SPR 20, DEX 100, LCK 35
Quotes:
...
Favorite Weapon: [Sonic Screwdriver](/items/Sonic Screwdriver)
Abilities: 
...
- [Air Dodge](/abilities/Air Dodge)
Limit Break: **Bunker Down** - Terra gains +10 to all stats, but is now 90% slower.
Lore: 
## Bio
